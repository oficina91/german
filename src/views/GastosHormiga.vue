...
const gastos = ref([
  ...
  { denuncia: 'La madre de la Ministra de Cultura está viviendo sabroso: más de 500 millones en contratos firmados durante este gobierno.', publicacion: 'https://x.com/german_ricaurte/status/2022507893623271854?s=20', fecha: '15/02/2026' },
  ...
  { denuncia: 'Ministerio de la Igualdad no ejecutó presupuesto para poblaciones vulnerables pero gastó 20 millones en torneos de bolos.', publicacion: 'https://x.com/german_ricaurte/status/1965191642106990699?s=46&t=EXEdvC7XmsGZ8MLyf_b2Uw', fecha: '08/09/2025' },
